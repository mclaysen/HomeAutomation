...
class ModelMapping:
    def __init__(
        self, model: str, sensorType: SensorType, sensors: List[SensorMapping]
    ) -> None:
        self.model = model
...
class Config:
    def __init__(
        ...
        ModelMappings: List[ModelMapping],
    ) -> None:
        self.DTE_IP = DTE_IP
        self.RTL_IP = RTL_IP
    ...
    def from_dict(cls, data: dict) -> "Config":
        ...
        return cls(
            data["DTE_IP"], data["RTL_IP"], data["HOME_ASSISTANT_IP"], modelMappings
        )
