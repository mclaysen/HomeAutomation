...
@mark.parametrize(
    "data, expected_detect_wet", [(0, False), (1, True), (-1, None), (None, None)]
)
...
@mark.parametrize(
    "data, expected_battery_level",
    [
        (0.01, BatteryLevel.EMPTY),
        (0.24, BatteryLevel.EMPTY),
        (0.25, BatteryLevel.LOW),
        (0.26, BatteryLevel.OK),
...
@mark.parametrize(
    ...
    [
        ("Button Press", LeakSensorEvent.BUTTON_PRESS),
